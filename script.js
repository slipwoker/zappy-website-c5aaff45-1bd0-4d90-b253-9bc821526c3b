document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function clearError(field) {
      ...
      const existingError = contactForm.querySelector('[data-error-for="' + field.name + '"]');
    ...
    function showFormFallback() {
      ...
      if (!errorEl) {
        ...
        errorEl.setAttribute('role', 'alert');
        contactForm.insertAdjacentElement('afterend', errorEl);
      }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "SWIMIT משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'c5aaff45-1bd0-4d90-b253-9bc821526c3b',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'c5aaff45-1bd0-4d90-b253-9bc821526c3b';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'c5aaff45-1bd0-4d90-b253-9bc821526c3b';
